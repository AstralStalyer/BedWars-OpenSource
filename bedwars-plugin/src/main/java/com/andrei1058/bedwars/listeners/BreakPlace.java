...
public class BreakPlace implements Listener {
    ...
    public void onExplode(final EntityExplodeEvent e) {
        ...
        final List<Block> glass = new ArrayList<Block>();
        ...
        for (final Block block2 : e.blockList()) {
            for (final Block glassblock : glass) {
        ...
        final List<Block> addblocks = new ArrayList<Block>();
        addblocks.add(location.clone().add(0.0, 1.0, 0.0).getBlock());
        addblocks.add(location.clone().add(0.0, -1.0, 0.0).getBlock());
        addblocks.add(location.clone().add(0.0, 0.0, 1.0).getBlock());
        addblocks.add(location.clone().add(0.0, 0.0, -1.0).getBlock());
        addblocks.add(location.clone().add(1.0, 0.0, 0.0).getBlock());
        addblocks.add(location.clone().add(-1.0, 0.0, 0.0).getBlock());
        for (final Block block3 : addblocks) {
