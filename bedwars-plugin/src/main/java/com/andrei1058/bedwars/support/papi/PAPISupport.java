...
public class PAPISupport extends PlaceholderExpansion {
    ...
    public String getAuthor() {
        return "andrei1058,Starry_Killer";
    }
    ...
    public String onPlaceholderRequest(Player player, String s) {
        ...
        switch (s) {
            ...
            case "player_rerq_xp":
                ...
                break;
            case "arena_player_kills":
                replay = String.valueOf(a == null ? BedWars.getStatsManager().get(player.getUniqueId()).getKills() : a.getPlayerKills(player, false));
                break;
            case "arena_player_finalkills":
                replay = String.valueOf(a == null ? BedWars.getStatsManager().get(player.getUniqueId()).getFinalKills() : a.getPlayerKills(player, true));
                break;
            case "arena_player_beds":
                replay = String.valueOf(a == null ? BedWars.getStatsManager().get(player.getUniqueId()).getBedsDestroyed() : a.getPlayerBedsDestroyed(player));
                break;
            case "player_status":
                if(a != null) {
                    switch (a.getStatus()) {
