...
public class MainConfig extends ConfigManager {
    ...
    public MainConfig(Plugin plugin, String name) {
        ...
        yml.options().header("BedWars 1.0.1-NEXTGEN By Starry_Killer\n");
        yml.addDefault("showcase", "false");
        ...
        try {
            ...
            else if (Objects.requireNonNull(yml.getString("serverType")).equalsIgnoreCase("BUNGEE_SINGLE")) {
                BedWars.setServerType(ServerType.BUNGEE);
                BedWars.setAutoscale(false);
                BedWars.setSingle(true);
            } else {
